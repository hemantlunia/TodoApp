...
<div class="max-w-sm m-4 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-[purple] dark:border-[red] relative">
    <p className={`mb-8 font-normal text-[white] break-words ${isComplete ? "line-through" : ""}`}>
        {text}
    </p>
